...
function runBaseTests() {
  px_view_1 = document.getElementById('px_view_1');

  suite('Base Automation Tests for px-view', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-view fixture is created', function() {
      assert.isTrue(document.getElementById('px_view_1') !== null);
    });
